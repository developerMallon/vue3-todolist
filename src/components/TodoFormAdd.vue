...
rounded-sm border-l-2 border-green-400 mb-3"
  >
    <input
      ...
      type="text"
      class="bg-gray-900 placeholder-gray-500 text-gray-500 font-light 
      focus:outline-none block w-full appearance-none leading-normal 
      py-3 pr-3"
    >
...
export default {
  ...
  methods: {
    addTodo () {
      ...
      return this.$store.dispatch('addTodo', {
        title: this.title,
        completed: false
      })
        .finally(
